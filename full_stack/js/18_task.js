...
class FrontendDeveloper extends Developer {
    ...
    buildUI() {
        console.log(this.name + " is building UI with " + this.framework);
    }
    work() {
        console.log(this.name + " is building frontend");
    }
}
...
let frontendDev = new FrontendDeveloper(102, "B", "JavaScript", "React");
